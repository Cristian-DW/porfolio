...
const ProjectsCard: React.FC<ProjectsCardProps> = ({ 
  ...
  return (
    <div className="relative w-72 h-44 md:w-[25rem] md:h-[40rem] shadow-md overflow-hidden transform transition-transform hover:scale-105 duration-1000 ease-in-out">
      <div
      ...
      <div className="absolute inset-0 bg-opacity-70 bg-black flex flex-col justify-center items-center text-white transform transition-opacity opacity-0 hover:opacity-100 duration-1000 ease-in-out">
        ...
        <div className="absolute top-0 left-0 w-12 h-20">
          <img width={32} height={32} src={tecnology1} alt="html" />
          <img width={32} height={32} src={tecnology2} alt="css" />
          <img width={32} height={32} src={tecnology3} alt="javascript" />
        </div>
      </div>
    </div>
  );
