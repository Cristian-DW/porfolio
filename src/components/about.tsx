        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-16 items-center">
          ...
          <div className="md:col-span-2 flex justify-center md:justify-start">
            <div className="relative w-[260px] h-[340px] md:w-[320px] md:h-[420px] flex-shrink-0">
              <div className="absolute w-full h-full bottom-5 -right-5 bg-brand/10 border border-brand/20 rounded-xl" />
              <img
                src={ImgAbout}
                alt="Cristian Castro"
                className="absolute z-10 w-full h-full object-cover rounded-xl border border-line/10 shadow-2xl"
                loading="lazy"
              />
            </div>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col justify-center">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-space tracking-tight mb-6 text-primary leading-tight animate-fade-up">
              {t('about.headline_line1')}{' '}
              <span className="text-gradient">{t('about.headline_line2')}</span>
            </h2>
            ...
            <div className="space-y-4 mb-8 animate-fade-up">
              <p className="text-sm md:text-base text-muted leading-relaxed">{t('about.para1')}</p>
              <p className="text-sm md:text-base text-muted leading-relaxed">{t('about.para2')}</p>
              <p className="text-sm md:text-base text-muted leading-relaxed">{t('about.para3')}</p>
            </div>
            ...
            <div className="flex gap-3 flex-wrap animate-fade-up">
              ...
              <Link to="work" smooth={true} duration={900}>
                <button className="h-11 px-7 rounded-full bg-surface-card border border-line/10 text-primary font-bold uppercase tracking-wider text-xs transition-all hover:border-brand hover:scale-105 active:scale-95">
                  {t('about.cta_work')}
                </button>
              </Link>
            </div>
