...
import ImgLinkedln from "../assets/linke.png"
    ...
    >
      ...
      <div className="lg:col-span-3 flex justify-between  md:justify-around lg:justify-between">
        <article className="hover:cursor-pointer">
          <ImageWithPopover
            imageUrl={ImgSena}
            name="Certificación tecnólogo en Analisís y Desarrollo de Software"
        ...
        <article className="hover:cursor-pointer">
          <ImageWithPopover
           imageUrl={ImgLinkedln}
           name="Certificación en Diseño UI/UX: Creando Conexiones Digitales"
           bio="Gracias a Likedln Leaning he aquirido experiencia en crear experiencias digitales atractivas y funcionales, garantizando la satisfacción del usuario a través de diseños intuitivos y efectivos."
           fecha="2023"
           ubication="Online"
