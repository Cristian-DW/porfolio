            ...
            <div className="flex flex-1 items-center 2xl:items-stretch 2xl:justify-between">
              ...
              <div className="hidden 2xl:ml-6 2xl:block">
                ...
                <Link
                  ...
                  smooth={true}
                  duration={900}
                  className="py-2 font-nav font-medium hover:border-b-2 button-hover cursor-pointer">
                    Conóceme
                  </Link>
                  <Link
                  to="skill"
                  ...
                  <Link
                      ...
                      smooth={true}
                      duration={900}
                      className="px-2 py-2 font-nav font-medium hover:border-b-2 button-hover cursor-pointer"
                    >
                    Educación
                    </Link>
                    <Link
